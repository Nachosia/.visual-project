...
object BtcHudModule {
    ...
    const val moduleId = "btc"
    const val showBpsKey = "${moduleId}:show_bps"
    const val showTpsKey = "${moduleId}:show_tps"
    const val showCoordsKey = "${moduleId}:show_coords"

    private val renderer = BtcHudRenderer()
    ...
    fun initialize() {
        ...
        ModuleStateStore.ensureSetting(showBpsKey, defaultValue = true)
        ModuleStateStore.ensureSetting(showTpsKey, defaultValue = true)
        ModuleStateStore.ensureSetting(showCoordsKey, defaultValue = true)
