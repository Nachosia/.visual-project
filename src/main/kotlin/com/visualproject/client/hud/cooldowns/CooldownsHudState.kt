...
data class CooldownsHudPosition(
    val x: Int,
    val y: Int,
)

data class CooldownsHudBounds(
    val x: Int,
    val y: Int,
    val width: Int,
    val height: Int,
...
class CooldownsHudDragState(initialPosition: CooldownsHudPosition) {

    var position: CooldownsHudPosition = initialPosition
        private set
