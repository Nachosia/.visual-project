...
data class ArmorHudPosition(
    val x: Int,
    val y: Int,
)

data class ArmorHudBounds(
    val x: Int,
    val y: Int,
    val width: Int,
    val height: Int,
...
class ArmorHudDragState(initialPosition: ArmorHudPosition) {

    var position: ArmorHudPosition = initialPosition
        private set
